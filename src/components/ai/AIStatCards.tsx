// src/components/ai/AIStatCards.tsx
'use client';

import { MessageSquare, Activity, ThumbsUp, TrendingUp } from 'lucide-react';
...
export default function AIStatCards({ stats }: AIStatCardsProps) {
  return (
